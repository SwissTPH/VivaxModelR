...
test_that("test simulation of future scenarios, with rcd", {
  mydata=data.frame(incidence=c(23,112,267)) %>%
    dplyr::mutate(
      ...
      nu.new=c(0,10,5), tau.new=c(5,5,5), eta.new=c(1,1,1), rho2.new=c(1,1,1))
...
test_that("test simulation of future scenarios starting from initial condition, at equilibrium (with 0 RCD)", {
  ...
  mydata=data.frame(incidence=c(23,112,267)) %>%
    dplyr::mutate(
      ...
      id=c(1,2,3),
      omega.old=c(0.7,0.7,0.7),
      nu.new=c(0,10,5), tau.new=c(5,5,5), eta.new=c(1,1,0),iota.new=c(5/7/10000,0,5/7/10000), rho2.new=c(1,1,1))
...
test_that("test simulation of future scenarios starting from initial condition, not at equilibrium", {
  ...
  mydata=data.frame(incidence=c(23,112,267)) %>%
    dplyr::mutate(
      ...
      id=c(1,2,3),
      omega.old=c(0.7,0.7,0.7),
      nu.new=c(0,10,5), tau.new=c(5,5,5), eta.new=c(1,1,1),iota.new=c(5/7/10000,5/7/10000,5/7/10000), rho2.new=c(1,1,1))
